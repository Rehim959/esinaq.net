<div class="page">
    ...
    <table class="table">
        ...
        <?php foreach ($exams as $e): ?>
            <tr>
                ...
                <td class="actions-cell">
                    ...
                    <?php elseif (in_array($e['status'], ['finished', 'cancelled'], true) && \App\Core\Auth::isSuperAdmin()): ?>
        ...
        <?php endforeach; ?>
        <?php if (empty($exams)): ?><tr><td colspan="10" class="muted"><?= e(__('no_exams')) ?></td></tr><?php endif; ?>
        </tbody>
    </table>
</div>
