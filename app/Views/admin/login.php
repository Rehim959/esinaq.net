<div class="auth-wrap">
    <form class="auth-card" method="post" action="<?= url('/admin/login') ?>">
        ...
        <?php endif; ?>
        <label><?= e(__('email')) ?><input type="email" name="email" value="" autocomplete="username" required></label>
        <label><?= e(__('password')) ?><input type="password" name="password" autocomplete="current-password" required></label>
